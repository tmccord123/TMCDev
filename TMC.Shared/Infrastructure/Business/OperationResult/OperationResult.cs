...
namespace TMC.Shared 
{
    ...
    public sealed class OperationResult<T>
    {
        ...
        public JCCValidationResult ValidationResult { get; private set; }
        ...
        private OperationResult(T data, OperationResultType resultType, string message, string stackTrace, JCCValidationResult validationResult)
        {
            this.Data = data;
        ...
        /// <returns></returns>
        [SuppressMessage(SuppressMessageConstants.DesignCategory, SuppressMessageConstants.DoNotDeclareStaticMembersOnGenericTypes)]
        public static OperationResult<T> CreateFailureResult(JCCValidationResult validationResult)
        {
